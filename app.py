...
UUID = os.environ.get('UUID', '20fc10c7-dfe2-43e3-8864-5d7699d82cb1')       # UUID
...
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'klagCI3ydy9DPZssGs')                                 # 哪吒客户端密钥
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', '48941081cc.future13800.eu.org')                             # 国定隧道域名，留空即启用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNjc0MmMxNDI5ZDE4OTA3NjMzZjMyZjQ2MWM5MzUwOWMiLCJ0IjoiOTFiMzVlOWYtNTQxYS00MWM0LTk5ZmEtMjNiNmQzODY5MDQ0IiwicyI6IllUQXdabUZpWm1RdFpXVmxaaTAwT0RsakxXSXpNbU10T1dOalpUVm1OMlZoTkRrMCJ9')                                 # 国定隧道json或token，留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
